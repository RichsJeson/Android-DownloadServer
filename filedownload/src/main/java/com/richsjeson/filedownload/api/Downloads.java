...
public final class Downloads implements BaseColumns {
     ...
     */
    public static final String AUTHORITY = "com.richsjeson.filedownload";
     ...
     * @hide
     */
    public static final String PERMISSION_ACCESS = "com.richsjeson.filedownload.permission.ACCESS_DOWNLOAD_MANAGER";
     ...
     * @hide
     */
    public static final String PERMISSION_ACCESS_ADVANCED = "com.richsjeson.filedownload.permission.ACCESS_DOWNLOAD_MANAGER_ADVANCED";

    /**
     * The permission to access the all the downloads in the manager.
     */
    public static final String PERMISSION_ACCESS_ALL = "com.richsjeson.filedownload.permission.ACCESS_ALL_DOWNLOADS";
     ...
     * @hide
     */
    public static final String PERMISSION_SEND_INTENTS = "com.richsjeson.filedownload.permission.SEND_DOWNLOAD_COMPLETED_INTENTS";

    /**
     * The permission to download files without any system notification being
     * shown.
     */
    public static final String PERMISSION_NO_NOTIFICATION = "com.richsjeson.filedownload.permission.DOWNLOAD_WITHOUT_NOTIFICATION";
     ...
     * Set to true if this download is deleted.
     * <P>
     * Type: COLUMN_ERROR_CODE 下载的错误状态值
     * </P>
     * <P>
     * Owner can Read
     * </P>
